...
export default function ClassDetail({ params }: { params: { id: string } }) {
  ...
  return (
    // <main className="flex min-h-screen w-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-[#15162c] text-white z-0"></main>
    <main className="flex min-h-screen flex-col items-center justify-center bg-orange-900 z-0">
      <div className="fixed-width-container bg-classes bg-center bg-no-repeat bg-cover p-6 pt-32 flex flex-col items-center min-h-screen">
        <Image
          src={Jellyfish2}
          alt="jellyfish-2"
          className="absolute -top-1 right-0 w-[20%] z-10"
        />
        <Image
          src={Jellyfish1}
          alt="jellyfish-1"
          className="absolute top-[6%] right-0 w-[27%] z-10"
        />
        <Image
          src={Coral1}
          alt="coral-1"
        ...
        <div className="mt-10">
          <Button className="mb-32 bg-pink-400" onClick={openModal}>
            Daftar
          </Button>
        </div>
