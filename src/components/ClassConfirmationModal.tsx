...
import Penyu from 'public/images/class/Penyu.png'
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      <AlertDialogContent className={cn(
        'w-[300px] px-6 pb-6 pt-10 bg-white rounded-[12px border border-orange-400 shadow-pink-xl', className
      )}>
        ...
        <AlertDialogDescription className='text-pink-400 text-center font-normal '>
          Apakah kamu yakin memilih <br />kelas ini?
        </AlertDialogDescription>
        <AlertDialogFooter>
          <AlertDialogAction className='bg-orange-400 text-white hover:bg-orange-300'>
            Pilih Sekarang
          </AlertDialogAction>
