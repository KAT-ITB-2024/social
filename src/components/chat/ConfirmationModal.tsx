        ...
        <AlertDialogFooter>
          <div className="flex flex-col items-center gap-y-4">
            <div className="flex items-center gap-x-4">
              <AlertDialogAction
                className="w-[120px] rounded-[13px] border-white bg-pink-300 font-body text-lg text-neutral-50 hover:bg-pink-400 hover:text-neutral-100 focus-visible:ring-transparent"
                onClick={onConfirm}
              >
                {buttonLabelConfirm}
              </AlertDialogAction>
              <AlertDialogCancel
                className="w-[120px] rounded-[13px] border-[2px] border-blue-200 bg-neutral-50 font-body text-lg text-blue-600 hover:bg-neutral-200"
                onClick={onCancel}
              >
                {buttonLabelCancel}
              </AlertDialogCancel>
