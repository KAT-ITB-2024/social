        ...
        <AlertDialogFooter>
          <div className="flex flex-col items-center gap-y-4">
            <div className="flex items-center gap-x-4">
              <AlertDialogCancel className="bg-pink-300 hover:bg-pink-400 border-white text-neutral-50 hover:text-neutral-100 rounded-[13px] font-body focus-visible:ring-transparent w-[120px] text-lg">
                {buttonLabelConfirm}
              </AlertDialogCancel>
              <AlertDialogAction className="bg-neutral-50 border-blue-200 border-[2px] text-blue-600 hover:bg-neutral-200 w-[120px] rounded-[13px] font-body text-lg">
                {buttonLabelCancel}
              </AlertDialogAction>
            </div>
